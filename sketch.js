...
function setup() {
  ...
  stricker = new Stricker(100, 200, 20, 20);

  slingshot = new SlingShot(stricker.body, {x:100, y:200});
}  
...
function mouseDragged(){
  Matter.Body.setPosition(stricker.body, {x: mouseX , y: mouseY});
}
...
function keyPressed(){
  if (keyCode===32){
      slingshot.attach(stricker.body);
  }
}